...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    """
    result = (dish_name, set(dish_ingredients))
    return result
...
def check_drinks(drink_name, drink_ingredients):
    ...
    result = f"{drink_name} {drink_type}"
    return result
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    result = f"{dish_name}: {dish_category}"
    return result
...
def tag_special_ingredients(dish):
    ...
    allergens = set(ingredients).intersection(SPECIAL_INGREDIENTS)
...
def compile_ingredients(dishes):
    ...
    """
    result = functools.reduce(lambda s1, s2: s1.union(s2), dishes)
    return result
...
def separate_appetizers(dishes, appetizers):
    ...
    result = list(dish_set.difference(appetizers_set))
...
def singleton_ingredients(dishes, intersection):
    ...
    """
    result = compile_ingredients(dishes) - intersection
